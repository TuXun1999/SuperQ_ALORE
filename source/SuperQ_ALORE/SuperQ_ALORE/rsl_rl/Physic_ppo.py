...
class PhysicPPO(PPO):
    """PPO variant that keeps the upstream API and adds a physic-estimator loss."""

    policy: PhysicActorCritic | ActorCritic | ActorCriticRecurrent
    ...
    def update(self) -> dict[str, float]:
        physic_estimator = getattr(self.policy, "physic_estimator", None)
        mean_value_loss = 0.0
