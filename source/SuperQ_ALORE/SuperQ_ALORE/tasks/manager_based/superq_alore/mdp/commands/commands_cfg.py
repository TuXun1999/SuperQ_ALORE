...
# )
from .goal_pose_command import GoalPoseCommand, GoalPoseCommandPLAY
...
@configclass
class GoalPoseCommandPLAYCfg(GoalPoseCommandCfg):
    """Configuration for a per-env sampled goal pose and corresponding object green marker at evaluation."""

    class_type: type = GoalPoseCommandPLAY
